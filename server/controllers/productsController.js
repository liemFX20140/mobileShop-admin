...
const baseURL = 'https://mobileshop-server.glitch.me';
...
exports.newProduct = async (req, res, next) => {
  ...
  const newProduct = new productsModel({
    ...
    img2: images[1] ? `${baseURL}/${images[1].path}` : '',
    img3: images[2] ? `${baseURL}/${images[2].path}` : '',
    img4: images[3] ? `${baseURL}/${images[3].path}` : '',
  });
